...
RUN apk --no-cache update && \
    ...
    apk --no-cache add php5 php5-json php5-phar php5-openssl php5-zlib php5-mcrypt php5-bcmath php5-curl php5-sockets && \
    apk --no-cache add py-pip nodejs nodejs-npm curl openssl groff less && \
